...
uint16_t ECOCALLMETHOD CEcoTask1Lab_C761620F_SetExecutionTime(IEcoTask1Ptr_t me, uint16_t time) {
    CEcoTask1Lab_C761620F* taskInstance = (CEcoTask1Lab_C761620F*)me;
    const uint16_t ERROR_CODE = 0xFFFF;
    
    if (me == 0 ) {
        return ERROR_CODE;
    }

    taskInstance->executionTime = time;
    return 0;
}


uint16_t ECOCALLMETHOD CEcoTask1Lab_C761620F_GetExecutionTime(IEcoTask1Ptr_t me) {
    CEcoTask1Lab_C761620F* taskInstance = (CEcoTask1Lab_C761620F*)me;
    const uint16_t ERROR_CODE = 0xFFFF;
    uint16_t result = 0;
    ...
    result = taskInstance->executionTime;
    return result;
}
...
IEcoTask1VTbl g_x81A466F4C27540B1B33D0661E5470F1BVTbl_C761620F = {
	...
	CEcoTask1Lab_C761620F_SetExecutionTime,
	CEcoTask1Lab_C761620F_GetExecutionTime
};
