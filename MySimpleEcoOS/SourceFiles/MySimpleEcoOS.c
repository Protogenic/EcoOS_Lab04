...
/* Печать строки журнала «Старт получения задачи #N (Момент входа: T)» в следующей строке экрана */
static void LogTaskStart(char_t* text, uint16_t timeIn) {
    ...
    fullText[pos++] = '\xcc'; fullText[pos++] = '\xee'; fullText[pos++] = '\xec';
    fullText[pos++] = '\xe5'; fullText[pos++] = '\xed'; fullText[pos++] = '\xf2';
    fullText[pos++] = ' '; fullText[pos++] = '\xef'; fullText[pos++] = '\xee';
    fullText[pos++] = '\xf1'; fullText[pos++] = '\xf2'; fullText[pos++] = '\xf3';
    fullText[pos++] = '\xf0'; fullText[pos++] = '\xe5'; fullText[pos++] = '\xed';
    fullText[pos++] = '\xe8'; fullText[pos++] = '\xff'; fullText[pos++] = ':';
    fullText[pos++] = ' ';
...
void Task1() {
    ...
    LogTaskStart("\xd1\xf2\xe0\xf0\xf2\x20\xef\xee\xeb\xf3\xf7\xe5\xed\xe8\xff\x20\xe7\xe0\xe4\xe0\xf7\xe8\x20\x23\x31", g_taskDuration1); /* «Старт получения задачи #1» */
...
void Task2() {
    ...
    uint64_t changeTime = currentTime + step;
	g_taskSteps = 0;
    LogTaskStart("\xd1\xf2\xe0\xf0\xf2\x20\xef\xee\xeb\xf3\xf7\xe5\xed\xe8\xff\x20\xe7\xe0\xe4\xe0\xf7\xe8\x20\x23\x32", g_taskDuration2); /* «Старт получения задачи #2» */
...
void Task3() {
    ...
    uint64_t changeTime = currentTime + step;
	g_taskSteps = 0;
    LogTaskStart("\xd1\xf2\xe0\xf0\xf2\x20\xef\xee\xeb\xf3\xf7\xe5\xed\xe8\xff\x20\xe7\xe0\xe4\xe0\xf7\xe8\x20\x23\x33", g_taskDuration3); /* «Старт получения задачи #3» */
...
void Task4() {
    ...
    uint64_t changeTime = currentTime + step;
	g_taskSteps = 0;
    LogTaskStart("\xd1\xf2\xe0\xf0\xf2\x20\xef\xee\xeb\xf3\xf7\xe5\xed\xe8\xff\x20\xe7\xe0\xe4\xe0\xf7\xe8\x20\x23\x34", g_taskDuration4); /* «Старт получения задачи #4» */
